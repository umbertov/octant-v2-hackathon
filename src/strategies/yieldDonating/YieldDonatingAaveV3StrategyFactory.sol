...
import {YieldDonatingAaveV3Strategy} from "./YieldDonatingAaveV3Strategy.sol";
...
contract YieldDonatingAaveV3StrategyFactory {
     ...
     */
    function newStrategy(address _lendingPool, address _asset, string calldata _name)
        external
        virtual
        returns (address)
    {
        ...
        IStrategyInterface _newStrategy = IStrategyInterface(
            address(
                new YieldDonatingAaveV3Strategy(
                    _lendingPool,
                    _asset,
                    _name,
                    management,
